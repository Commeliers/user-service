package hp.home_protector.global.common.auth;
...
public class JwtTokenFilter extends GenericFilter {
    ...
    public JwtTokenFilter(BlacklistedTokenService blacklistedTokenService) {
        ...
        try {
            ...
            if(token !=null){
                ...
                if (blacklistedTokenService.isTokenBlacklisted(jwtToken)) {
                    throw new AuthenticationServiceException("토큰이 무효화되었습니다.");
                }
